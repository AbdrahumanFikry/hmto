...
class Agents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
          future:
              Provider.of<FieldForceData>(context, listen: false).fetchAgents(),
...
//                              width: MediaQuery.of(context).size.width * 0.3,
                                              ...
                                              percent: data
                                                  ...
                                                  : double.parse(data
                                                      ...
                                                      100,
                                              center: Text(
                                                  "${data.agentsModel.data[index].analysis == null ? 'No Target' : data.agentsModel.data[index].analysis.visited}"),
                                              linearStrokeCap:
